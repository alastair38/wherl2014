  ...
  if (!is_admin()) {
   ...
   // loads jQuery 2.1.0
    ...
    wp_enqueue_script( 'transit-js', get_template_directory_uri() . '/library/js/transit.js', array( 'jquery' ), '', true );
      ...
      // adding Touchswipe JS scripts file in the footer
    wp_enqueue_script( 'touchswipe-js', get_template_directory_uri() . '/library/js/touchSwipe.js', array( 'jquery' ), '', true );
...
if ( is_front_page() ) {
    ...
    wp_enqueue_style( 'normalize-stylesheet', get_stylesheet_directory_uri() . '/bower_components/foundation/css/normalize.css', array(), '', 'all' );
